...
grow. At this point, the multi encryption ballot encoding comes in. In order to
get better performance in small voting scenarios while being able to perform
...
As a threshold value, the number $10\,000$ has been chosen. If $s$ is smaller,
the single encryption ballot encoding is used, the multi encryption ballot
strategy otherwise.
