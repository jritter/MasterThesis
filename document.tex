...
can see in \Vref{tab:comparisonofvoteencodings}, the single ballot encryption is in
...
\begin{table}[htbp]
	...
	\begin{tabularx}{\textwidth}{lcc}
		...
		Decryption operations / option & $k$ & $1$ \\
		Number of combinations for decoding & $k\cdot n$ & $\binom{n-k-1}{o-k}$ \\
		\bottomrule
	\end{tabularx}
	\end{minipage}
	\renewcommand{\arraystretch}{1}
