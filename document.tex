...
\Vref{fig:singleencryptionencoding} illustrate how such a vector would look like
...
\Vref{fig:singleencryptionencodingresult} illustrates the bitvector $v$
...
\section{Timeline}
\label{sec:planning}
\paragraph{Orignial planning.} The gantt chart in \Vref{fig:projectplanning}
...
common codebase. \Vref{tab:sourcecoderepositories} outlines the three
...
combination in order to avoid the discrete logarithm problem, very similar to
