...
footsepline, twoside, openright, draft=off, listof=leveldown]{scrreprt}
...
instances of the bulletin board are available. The CGS97 scheme does not specify
...
\noindent\resizebox{\textwidth}{!}{
	...
	\gantttitle{Calendar weeks 2013 / 2014}{52} \\
	...
	\ganttbar{Testing example code on Android}{14}{14} \\
	\ganttbar{Integration of code into Android project}{15}{15} \\
	\ganttgroup{Implementation of e-voting application on Android}{20}{39} \\
...
are discussed in \Vref{sec:CGS97}. This section gives an overview of some
...
participant. This does not create a conflict because a trustee can also be a
...
considered as a centralized high available infrastructure. This paradigm cannot
...
in \Vref{sec:ballotencoding} we discussed two approaches, each with its own
...
chosen. \Vref{fig:xmlstructuremulti} depicts the structure which is used for a
multi encryption ballot vote, \Vref{fig:xmlstructuresingle} the structure used
...
perform a vote in a decentralized manner, but did not offer the desired
...
\myref{cha:organisation}. This allows us to compare each others implementation.
...
\myref{sec:singleencryptionballot}. This means that the time consumption of the
tallying process grows rapidly as the number of participants and options increase.
...
multi encryption ballot strategy \myref{sec:multiencryptionballot}.
...
section. After starting up the MobiVote app, the participants now choose the
...
As soon as all participants have joined their devices to the voting
...
possibility to repeat the vote. This comes in handy if several voting rounds are
